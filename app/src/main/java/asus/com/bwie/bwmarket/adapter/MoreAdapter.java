...
public class MoreAdapter extends RecyclerView.Adapter<MoreAdapter.ViewHolder> {
    ...
    private List<ClickMoreBean.ResultBean> resultBeans=new ArrayList<>();
    ...
    public void setResultBeans(List<ClickMoreBean.ResultBean> resultBeans) {
    ...
    public MoreClickListenter listenter;

    public  void setOnMoreClickListenter(MoreClickListenter clickListenter){
        listenter=clickListenter;
    }


    public interface MoreClickListenter{
